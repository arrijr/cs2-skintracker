// /backend/scripts/fixCaseImagesWorking.js — [Backend]
...
// Real working case image URLs from Steam
const caseImageMap = {
...
async function fixCaseImagesWorking() {
  console.log("🖼️ Fixing case images with working URLs...");
