// /backend/scripts/fixCaseImagesFinal.js — [Backend]
// {/* Fix case images with real working different URLs */}
import "dotenv/config";
import { PrismaClient } from "@prisma/client";

const prisma = new PrismaClient();

// Real working case image URLs - using different Steam CDN formats
const caseImageMap = {
...
async function fixCaseImagesFinal() {
  console.log("🖼️ Fixing case images with final working URLs...");
  ...
  try {
    ...
    console.log("🎉 All case images updated with final working URLs!");
