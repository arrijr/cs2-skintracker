// /backend/scripts/fixCaseImagesDifferentFinal.js — [Backend]
// {/* Fix case images with different working URLs */}
import "dotenv/config";
import { PrismaClient } from "@prisma/client";

const prisma = new PrismaClient();

// Different working case image URLs - using various Steam CDN formats
const caseImageMap = {
...
async function fixCaseImagesDifferentFinal() {
  console.log("🖼️ Fixing case images with different final working URLs...");
  ...
  try {
    ...
    console.log("🎉 All case images updated with different final working URLs!");
