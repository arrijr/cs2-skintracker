// /backend/scripts/fixCaseImagesRealWorking.js — [Backend]
// {/* Fix case images with real working URLs */}
import "dotenv/config";
import { PrismaClient } from "@prisma/client";

const prisma = new PrismaClient();

// Real working case image URLs - using different Steam CDN format
const caseImageMap = {
...
async function fixCaseImagesRealWorking() {
  ...
  try {
    ...
    console.log("🎉 All case images updated with working URLs!");
